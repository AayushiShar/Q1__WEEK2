...
import java.nio.file.Files;// part of JAVA NIO pacckage Paths.get method convert seqn of streams into path
...
public class AnnotationFinderDriverClass {
    ...
    public static void findAnnotatedClassesAndMethods() {
        try (Stream<Path> paths = Files.walk(Paths.get("src/main/java/com/example/demo/annotationmodels"))) {
            paths
                    ...
                    .forEach(AnnotationFinderDriverClass::processFile);//calling processFile method for filtered out files
        } catch (IOException e) {
